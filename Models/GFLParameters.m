...
%Fault
Fault.Type = 'A-G'; %Options are {'No fault'  'A-G'  'AB'  'AB-G'  'ABC'  'ABC-G'}
Fault.m = 0.5; %pu length
Fault.R = 1; %ohm
Fault.StartTime = 2.505; %Fault injection simulation time in s
...
% Parameters
ConvCtrl.Freq = Fnom;
ConvCtrl.Ts=100e-6;   % Control system time step (s)
...
ConvCtrl.FF.R = gridInverter.lineResistance*gridInverter.apparentPower*1e3/(gridInverter.lineRMSVoltage)^2;
