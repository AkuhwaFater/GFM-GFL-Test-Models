function PlotDistanceElement(TL,Data,FigNumber)
    ...
    plot(Data.mZ1L_Est.Data(end),'x','LineWidth',15,'DisplayName',['Rf=' num2str(Data.faultResistance) '$\Omega$; ' 'm=' num2str(Data.faultDistance) 'pu; ' 'SCR=' num2str(Data.SCR)]);
